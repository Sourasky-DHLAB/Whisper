...
כדי להשתמש במחברות יש להיעזר ב־Google Colab – כלי שמאפשר לנו לצפות ולהריץ את המחברות שהכנו עבורכם מראש. <img src="https://github.com/Sourasky-DHLAB/Whisper/blob/main/colab.png" style="display: block; margin-left: auto; margin-right: auto;">
